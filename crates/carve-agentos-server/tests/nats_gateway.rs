...
use carve_agent::{
    AgentDefinition, AgentOsBuilder, MemoryStore, StepContext, ThreadReadStore, ThreadWriteStore,
};
...
fn make_os(storage: Arc<dyn ThreadWriteStore>) -> carve_agent::AgentOs {
