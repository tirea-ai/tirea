...
type FrontendAction<T extends Parameter[] | [] = [], N extends string = string> = Action<T> & {
    ...
    render?: string | (T extends [] ? (props: ActionRenderPropsNoArgs<T>) => string | React__default.ReactElement : (props: ActionRenderProps<T>) => string | React__default.ReactElement);
    ...
    render?: never;
    /** @deprecated use renderAndWaitForResponse instead */
    renderAndWait?: T extends [] ? (props: ActionRenderPropsNoArgsWait<T>) => React__default.ReactElement : (props: ActionRenderPropsWait<T>) => React__default.ReactElement;
    renderAndWaitForResponse?: T extends [] ? (props: ActionRenderPropsNoArgsWait<T>) => React__default.ReactElement : (props: ActionRenderPropsWait<T>) => React__default.ReactElement;
    handler?: never;
});
type CatchAllFrontendAction = {
    name: "*";
    render: (props: CatchAllActionRenderProps<any>) => React__default.ReactElement;
};
